      ...
      <footer className="border-t border-rule">
        <div className="mx-auto max-w-5xl px-4 py-10 text-xs leading-relaxed text-ink-soft">
          <p className="max-w-3xl">
            Prices are daily closes via Yahoo Finance, refreshed each weekday. Year-to-date is
            measured from the first 2026 trading close and is split-adjusted. Non-USD names show
            local-currency prices; percentage changes are currency-neutral. Not investment advice —
            a market-watching broadsheet, not a terminal.
          </p>
